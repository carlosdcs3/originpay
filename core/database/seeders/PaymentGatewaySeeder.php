...
class PaymentGatewaySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $gateways = [
            [
                'code'                => 'mock',
                'logo'                => 'general/static/gateway/mock.png',
                'name'                => 'Mock (Sandbox)',
                'currencies'          => json_encode(['BRL']),
            ...
            [
                'code'                => 'efi',
                'logo'                => 'general/static/gateway/efi.png',
                'name'                => 'Efí Bank',
                'currencies'          => json_encode(['BRL']),
                'credentials'         => json_encode([
                    'client_id'     => '',
                ...
                'withdraw_field'      => null,
                'status'              => 0, // Inativo por padrão até configurar
                'priority'            => 2,
                'is_sandbox'          => true, // Sandbox true por padrão
                'supports_pix'        => true,
                'supports_card'       => false,
                'supports_refund'     => true,
