...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        then: function () {
            ...
            Route::middleware(['web', 'auth:admin', 'verified', 'XSS', 'lock_screen', '2fa', 'demo', \App\Http\Middleware\AdminAuditMiddleware::class])
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->append([
            SecureHeaders::class,
            \App\Http\Middleware\EmergencyReadOnlyMiddleware::class,
            \App\Http\Middleware\FinancialMaintenanceMiddleware::class,
        ...
        $middleware->alias([
            ...
            'api.request_id'       => \App\Http\Middleware\AssignRequestId::class,
            'api.idempotency'      => \App\Http\Middleware\CheckIdempotency::class,
            'api.transaction_password' => \App\Http\Middleware\EnsureApiTransactionPassword::class,
            'api.scope'            => \App\Http\Middleware\EnsureApiKeyScope::class,
            'admin.permission'     => \App\Http\Middleware\EnsureAdminPermission::class,
            'transaction.password' => \App\Http\Middleware\CheckTransactionPassword::class,
            'transaction.verified' => \App\Http\Middleware\EnsureTransactionPasswordVerified::class,
            'api.rate_limiter'     => \App\Http\Middleware\AdvancedRateLimiter::class,
        ]);
    })
    ->withCommands([
