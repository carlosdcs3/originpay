...
<body>
    <div class="error-container">
        ...
        <div class="error-title">Muitas Requisições</div>
        <div class="error-desc">Você enviou requisições demais em pouco tempo. Por favor, aguarde alguns instantes e tente novamente.</div>
