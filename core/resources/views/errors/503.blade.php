...
<body>
    <div class="error-container">
        ...
        <div class="error-title">Serviço Indisponível</div>
        <div class="error-desc">Nosso sistema está passando por manutenção temporária ou está sobrecarregado. Voltaremos em breve.</div>
