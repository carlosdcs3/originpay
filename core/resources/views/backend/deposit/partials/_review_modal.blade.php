<div class="modal fade" id="review-{{ $transaction->id }}" tabindex="-1" aria-labelledby="depositModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            {{-- Modal Header --}}
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title fw-bold" id="depositModalLabel">{{ __('Deposit Details') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="card border mb-3">
                        <div class="card-body p-3">
                            <h6 class="fw-bold text-primary mb-3">{{ __('Deposit Information') }}</h6>
                            ...
                            <div class="d-flex justify-content-between">
                                <span class="fw-bold">{{ __('Amount to deposit') }}</span>
                    ...
                    <div class="card border mb-3">
                        <div class="card-body p-3">
                            <h6 class="fw-bold text-primary mb-3">{{ __('Account Details for deposit') }}</h6>
                ...
                <div class="modal-footer bg-light p-3">
                    <div class="d-flex w-100">
                        <button type="submit" value="approve" name="action"
                            ...
                            <i class="fa-solid fa-check me-2"></i> {{ __('Approve Deposit') }}
                        </button>
                        <button type="submit" value="reject" name="action"
                            ...
                            <i class="fa-solid fa-times me-2"></i> {{ __('Reject Deposit') }}
                        </button>
                    </div>
                </div>
            </form>
