<div class="d-flex justify-content-end mb-3">
	<form action="{{ route('admin.transaction') }}" method="GET" class="row g-2 g-md-3">
		{{-- Date Range Picker --}}
		...
		{{-- Type Filter --}}
		<div class="col-md-6 col-xl-auto">
			<x-form.select name="type" label="{{ __('Transaction Type') }}"  class="form-select-md"
			               :options="\App\Enums\TrxType::options()"
