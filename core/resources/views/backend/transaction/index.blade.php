...
@section('finance_title', 'Transações')
@section('finance_desc', 'Monitoramento e auditoria de transações do sistema.')
...
@section('finance_content')
    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-md-8 text-md-end">
            ...
            <a href="{{ request()->fullUrlWithQuery(['export' => 'csv']) }}" class="btn btn-primary shadow-sm ms-2">
                <i class="la la-download me-1"></i> Exportar
            </a>
        </div>
    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-md me-2">
                                        @isset($transaction->user->avatar)
                                            <img class="avatar-img" src="{{ asset($transaction->user->avatar) }}" height="40" alt="User Avatar">
                                        @else
