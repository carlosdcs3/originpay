...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <div>
            <h1 class="fs-5 fw-semibold mb-0" style="color: var(--ds-text);">@yield('setting_title', 'Configurações')</h1>
            <p style="color: var(--ds-text-muted); font-size: 0.75rem; margin: 0;">Gerencie as preferências da plataforma e opções avançadas.</p>
        </div>
