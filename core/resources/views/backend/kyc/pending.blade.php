        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center my-3">
                    <h1 class="h3 fw-bold">{{ __('KYC Pending Requests') }}</h1>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <form action="{{ route('admin.kyc.pending') }}" method="GET" class="row mb-3 g-3 align-items-end">
                            <div class="col-auto">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset($submission->user->avatar_alt) }}"
                                                     ...
                                                     width="40" height="40">
                                                <div>
                                                    <div><a href="{{ route('admin.user.manage', $submission->user->username) }}" class="text-decoration-none">{{ $submission->user->name }}</a></div>
