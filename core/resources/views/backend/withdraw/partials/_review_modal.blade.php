<div class="modal fade" id="review-{{ $transaction->id }}" tabindex="-1" aria-labelledby="withdrawModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.withdraw.request-action') }}" method="post">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="card border">
                        <div class="card-body p-3">
                            <h6 class="fw-bold text-primary mb-3">{{ __('Add Your Remarks / Manual Reference (Optional)') }}</h6>
                            <textarea class="form-control" name="remarks" id="remarks" rows="3"
                                      placeholder="{{ __('Write your remarks or reference number here...') }}"></textarea>
                        </div>
                    </div>
                </div>
