...
@section('title', 'Origin Connect - Campanhas')
...
<div class="v2-settings-card">
    <div class="v2-settings-header" style="justify-content: space-between;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                <h5 class="v2-settings-title">Campanhas</h5>
                <p class="v2-settings-desc">Gestão de Campanhas do Origin Connect.</p>
            </div>
        </div>
    ...
    <div class="v2-settings-body">
        <p class="text-muted">Lista de Campanhas aparecerá aqui.</p>
    </div>
</div>
@endsection
