...
@section('title', 'Origin Connect - Analytics')
...
<div class="v2-settings-card">
    <div class="v2-settings-header" style="justify-content: space-between;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                <h5 class="v2-settings-title">Analytics</h5>
                <p class="v2-settings-desc">Gestão de Analytics do Origin Connect.</p>
            </div>
        </div>
    ...
    <div class="v2-settings-body">
        <p class="text-muted">Lista de Analytics aparecerá aqui.</p>
    </div>
</div>
@endsection
