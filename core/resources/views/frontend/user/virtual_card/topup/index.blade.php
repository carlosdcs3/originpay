		...
		<div class="col-xl-7 mx-auto">
			<div class="v2-card">
				<div class="v2-card-header d-flex flex-wrap justify-content-between align-items-center">
					<h2 class="v2-card-title mb-0">{{ __('Top Up Virtual Card') }}</h6>
					<a class="v2-btn-secondary btn-sm" href="{{ route('user.transaction.index', ['type' => \App\Enums\TrxType::CARD_TOPUP]) }}">
