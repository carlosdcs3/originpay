...
@section('content')
    <div class="v2-card">
        <div class="v2-card-header d-flex flex-column flex-md-row justify-content-between align-items-center mb-3">
            <h2 class="v2-card-title mb-2 mb-md-0">{{ __('Cardholders') }}</h6>
            <div class="d-flex gap-2 flex-row">
                <a class="v2-btn-secondary btn-sm" href="{{ route('user.virtual-card.index') }}">
                    <i class="fa-solid fa-list me-1"></i>{{ __('My Cards') }}
                </a>
                <a class="v2-btn-secondary btn-sm" href="{{ route('user.virtual-card.cardholders.create') }}">
        ...
        <div class="v2-card-body">
            <div class="table-responsive">
                <table class="table ds-dark-table align-middle mb-0">
                            ...
                            <td class="text-end">
                                <div class="btn-group align-items-center" role="group" aria-label="Cardholder Actions">
                                    @if($cardholder->status->isPending())
                                        <a href="{{ route('user.virtual-card.cardholders.show', $cardholder) }}" class="v2-btn-secondary btn-sm d-inline-flex justify-content-center align-items-center p-0 text-center" style="width:40px; height:40px;" title="{{ __('View') }}">
