...
@section('content')
    <div class="v2-card">
        <div class="v2-card-header d-flex flex-column flex-md-row justify-content-between">
            <h2 class="v2-card-title mb-2 mb-md-0">{{ __('My Virtual Cards') }}</h6>
            <div class="d-flex gap-2 flex-row">
                ...
                <a class="v2-btn-secondary btn-sm" href="{{ route('user.virtual-card.request.index') }}"><i class="fa-solid fa-list"></i>{{ __('My Requests') }}</a>
                <button type="button" class="v2-btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#requestVirtualCardModal"><i
                                    ...
                                    <span class="ms-2 d-flex align-items-center">
                                        ...
                                        @else
                                            @if(!empty($card->meta['card_id']))
                                                <button type="button"
                                                        class="v2-btn-primary show-card-details"
