...
@section('content')
    <div class="v2-card">
        <div class="v2-card-header mb-0 d-flex flex-column flex-md-row justify-content-between">
            <h2 class="v2-card-title mb-2 mb-md-0">{{ __('My Virtual Card Requests') }}</h6>
            <div class="d-flex gap-2 flex-row">
                <a class="v2-btn-secondary btn-sm" href="{{ route('user.virtual-card.index') }}"><i class="fa-solid fa-list"></i>{{ __('My Cards') }}</a>
                <button type="button" class="v2-btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#requestVirtualCardModal">
        ...
        <div class="v2-card-body">
            <div class="table-responsive">
                <table class="table ds-dark-table align-middle mb-0" style="background:transparent;">
