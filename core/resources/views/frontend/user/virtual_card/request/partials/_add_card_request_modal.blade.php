				...
				@if(!$wallets->isEmpty())
					<form action="{{ route('user.virtual-card.request.store') }}" method="post" autocomplete="off">
						...
						<div class="mb-3">
							...
							<select name="cardholder_id" id="cardholder_id" class="v2-input" required aria-required="true">
						...
						<div class="mb-3">
							...
							<select name="network" id="network" class="v2-input" required aria-required="true">
						...
						<div class="mb-3">
							...
							<div class="input-group">
								<select name="wallet_id" id="wallet_id" class="v2-input" required aria-required="true" disabled>
