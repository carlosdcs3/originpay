<div class="col-12">
    <div class="v2-card">
        <div class="v2-card-body d-flex flex-column flex-lg-row align-items-center p-4">
            <div class="flex-grow-1">
                <div class="mb-3">
                    <h6 class="text-secondary">{{ $referralContent->getLocalizedHeading() }}</h6>
                </div>

                <div class="v2-input-group mt-3">
                    <div class="input-group input-group-right">
                        <input type="text" id="referLink"
                               class="v2-input fw-bold text-muted" name="amount"
