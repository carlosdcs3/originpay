...
@section('favicon', asset('frontend/images/originpay/originpay-logo-horizontal-dark.svg'))
    ...
    <div class="container d-flex justify-content-center py-5">
        <div class="card shadow-sm border-0 rounded-4 p-4">
            ...
            @if($data['is_sandbox'] ?? false)
                <div class="alert border-0 test-payment-info mb-4 py-2 px-3">
                    <details>
                        <summary class="text-primary fw-bold" style="cursor:pointer; outline: none;">
                            <i class="fas fa-info-circle me-2" aria-hidden="true"></i>@lang('Test Payment Info')
                        </summary>
                        <div class="row g-2 mt-2">
                            ...
                            <div class="col-md-6">
                                <div class="bg-white rounded p-2 border">
                                    ...
                                    <small class="text-muted">@lang('Instant redemption')</small>
                                </div>
                            </div>
                        </div>
                    </details>
            ...
            <div class="bg-light p-3 rounded d-flex align-items-center justify-content-between border-dashed mb-4">
                <img src="{{ asset(setting('logo')) }}" alt="{{ 'OriginPay' }}" class="img-fluid icon text-primary me-3 fs-3">
                <div class="text-end">
            ...
            <ul class="nav nav-pills nav-justified mb-4" id="paymentTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="wallet-tab" data-bs-toggle="pill" data-bs-target="#wallet-pay" type="button" role="tab" aria-controls="wallet-pay" aria-selected="true">
                        <i class="fas fa-wallet me-1" aria-hidden="true"></i> @lang('Wallet Payment')
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="voucher-tab" data-bs-toggle="pill" data-bs-target="#voucher-pay" type="button" role="tab" aria-controls="voucher-pay" aria-selected="false">
                        <i class="fas fa-ticket-alt me-1" aria-hidden="true"></i> @lang('Voucher Payment')
                    </button>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="wallet-pay" role="tabpanel" aria-labelledby="wallet-tab">
                    <div class="text-center mb-3">
                        <small class="text-muted d-block">
                            @lang('Pay using your :site_title :wallet_name Wallet ID or log in for a faster checkout.', ['site_title' => 'OriginPay', 'wallet_name' => $data['currency']])
                        </small>
                        @auth
                    ...
                    <form id="paymentForm" action="{{ route('payment.complete') }}" method="post" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm rounded">
                                <span class="input-group-text bg-light">
                                    <i class="fas fa-wallet text-secondary" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm rounded">
                                <span class="input-group-text bg-light">
                                    <i class="fas fa-key text-secondary" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="d-grid mt-4">
                            <button id="payButton" type="submit" class="btn btn-primary fw-bold rounded-pill" disabled>
                ...
                <div class="tab-pane fade" id="voucher-pay" role="tabpanel" aria-labelledby="voucher-tab">
                    ...
                    <form id="voucherForm" action="{{ route('payment.complete') }}" method="post" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm rounded">
                                <span class="input-group-text bg-light">
                                    <i class="fas fa-ticket-alt text-secondary" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="d-grid mt-4">
                            <button id="voucherPayButton" type="submit" class="btn btn-primary fw-bold rounded-pill">
                                <i class="fas fa-arrow-right me-2" aria-hidden="true"></i> 
                                @lang('Redeem & Pay')
                            </button>
                        </div>
