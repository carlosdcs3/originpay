    ...
    public function requestAction(Request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($submission, $validated) {
                $status = $validated['action'] === 'approve' ? KycStatus::APPROVED : KycStatus::REJECTED;
                ...
                $submission->user->update([
                    ...
                    'kyc_reason' => $status === KycStatus::REJECTED ? ($validated['remarks'] ?? null) : null
                ]);
