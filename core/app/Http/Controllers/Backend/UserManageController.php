...
class UserManageController extends BaseController
{
    ...
    public function passwordUpdate($id, Request $request)
    {
        ...
        notifyEvs('success', __('Senha atualizada com sucesso'));
    ...
    public function updateBalance(Request $request)
    {
        ...
        try {
            ...
            if (! $isAdding && $wallet->available_balance < $amount) {
                throw new NotifyErrorException(__('Insufficient available balance in the wallet.'));
            }
