...
class WalletController extends Controller
{
    ...
    public function validateRecipient($role, $emailOrWalletId)
    {
        ...
        if (filter_var($emailOrWalletId, FILTER_VALIDATE_EMAIL) || User::where('username', $emailOrWalletId)->exists()) {
            // Handle email or username input
            $type = 'email';
            $user = User::where('email', $emailOrWalletId)->orWhere('username', $emailOrWalletId)->first();
